...
// Registry — same shape as s02. Toolset labels now meaningfully include
// "skill-<name>" (introduced this session). The shadowing rules carry over
// unchanged: skills can never override builtins, two skills can't share a
// name, an MCP tool can replace another MCP tool.

...
| s02   | Tool registry | Unified registry; later MCP and skill commands plug in here | ⏳ |
| s03   | Skills system | **Markdown prompts + template substitution + inline shell expansion** ★signature | ⏳ |
